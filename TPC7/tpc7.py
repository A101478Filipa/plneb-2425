...
file=open("C:/Users/filip/OneDrive/Ambiente de Trabalho/Universidade/Mestrado/2ºsemestre/Processamento de Linguagem Natural/TPC7/LIVRO-Doenças-do-Aparelho-Digestivo.txt", encoding="UTF-8")
texto=file.read()
file.close()


db_file=open("C:/Users/filip/OneDrive/Ambiente de Trabalho/Universidade/Mestrado/2ºsemestre/Processamento de Linguagem Natural/TPC7/_conceitos_.json",encoding="UTF-8") 
...
def conceitos_api_desi(designacao):
    ...
    if designacao in designacoes:
        descricao = db[designacao]
        return render_template("conceito2.html", designacao=designacao, descricao=descricao, title="Conceito")
    else:
        return render_template("conceito2.html", designacao="Erro", descricao="Descrição não encontrada", title="Conceito")
